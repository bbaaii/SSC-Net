...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--para_dir', type=str, default='./checkpoints/wholehlc', help='where to load the transfer model')
        ...
        #parser.add_argument('--lambda_fre', type=float, default=1., help='weight for cycle loss (A -> B -> A)')
        #parser.add_argument('--lambda_color', type=float, default=1., help='weight for cycle loss (B -> A -> B)')
